    ...
    return (
        <div className='bg-[#17242A] h-[700px] container-bottom border-b-2 border-[#FEFFFF]'>
            <div className='mt-16 ml-6 lg:ml-16'>
                <div className='h-[100px] lg:h-[170px] flex gap-2 mt-14 mb-5'>
                    <div><h4 className='text-3xl lg:text-7xl text-[#FEFFFF] font-bold mt-4 mb-4 animate__animated animate__fadeInDown'>Property</h4></div>
                    <div className='border-[3px] lg:border-[5px] border-[#FEFFFF]'></div>
                    <div className='flex items-end'><h4 className='text-3xl lg:text-7xl text-[#FEFFFF] font-bold mb-4 mt-4 animate__animated animate__fadeInUp'>Prospect</h4></div>
                </div>
